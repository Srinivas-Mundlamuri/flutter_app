  ...
  Future<void> onStarted(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final productsData = ProductsListModel.fromJson(data);
      ...
      final productsData = _getDummyProducts();
      emit(ProductsListLoaded(productsData.products));
    }
  }

  ProductsListModel _getDummyProducts() {
    String jsonData = '''{
      "products": [
        {
          "id": 1,
    ...
    return ProductsListModel.fromJson(jsonDecode(jsonData));
  }
}